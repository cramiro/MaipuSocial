...
<html lang="en">
  <head>
	...
	<script type="text/javascript" src="js/social-jquery.js"></script>
  ...
  <body>
    ...
    <div class="topbar">
      <div class="topbar-inner">
        <div class="container-fluid">
          <a class="brand" href="#">MaipuSocial</a>
          <ul class="nav">
    ...
    <div class="container-fluid">
      ...
      <div class="content">
        ...
        <div class="hero-unit">
            <!--<form>-->
			<?php echo form_open('social/search');?>
            <h5>Hot-Search!</h5>
			...
			<div id="search-options" class="span12" style="display:none;">
			<ul class="inputs-list" >
			  <li>
				<label>
					<?php echo form_checkbox('facebook', 'facebook', FALSE);?>
					<!--<input type="checkbox" value="option1" name="opcionesAvanzadas" />-->
					<span>Facebook</span>
				</label>
			  </li>
			  <li>
				<label>
					<?php echo form_checkbox('blogs', 'blogs', FALSE);?>
					<!--<input type="checkbox" value="option2" name="opcionesAvanzadas" />-->
					<span>Blogs</span>
				</label>
			  </li>
			  <li>
				<label>
                	<?php echo form_checkbox('foros', 'foros', FALSE);?>
                	<span>Foros</span>
              	</label>
			  </li>
			</ul>
