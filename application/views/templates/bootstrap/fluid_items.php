            ...
            foreach ($item as $key => $value){
                ...
                // Que la URL de la imagen tenga algunos caracteres
                if (strlen($value['user_image']) > 1 ){
...
//                echo "<\div>";
            ...
            */
            ...
            $save_search .= "<button id='save-search' class='btn large success' data-toggle='toggle' data-loading-text='Guardando...' data-complete-text='Búsqueda Guardada.' onclick='saveSearch(\"".site_url('social/temp_to_saved_search')."\");'>Guardar Búsqueda!</button>";
            $save_search .= "</div>";
            echo $save_search;
            }
